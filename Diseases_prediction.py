# -*- coding: utf-8 -*-
"""
Created on Sun Feb 9 19:51:26 2025
...
# Insert custom CSS to change the color 
    ...
    # Top Hospitals in India & Hyderabad
    st.markdown("## Top Hospitals in India")
    hospitals_india = [
        ...
        "8. Max Super Speciality Hospital, Delhi"
    ]
    st.write("\n".join(hospitals_india))
    
    st.markdown("## Top Hospitals in Hyderabad")
    hospitals_hyderabad = [
        "1. Apollo Hospitals, Jubilee Hills" "[Apollo Hospitals](https://www.apollohospitals.com/) is a renowned multi-specialty hospital offering advanced healthcare services. It is equipped with state-of-the-art facilities and a team of experienced specialists.",
        "2. Yashoda Hospitals" "[Yashoda Hospitals](https://www.yashodahospitals.com/) is a leading healthcare provider in Hyderabad, operating multiple branches across the city with specialized institutes for heart and cancer care.",
        "3. KIMS Hospitals" "[KIMS Hospitals](https://www.kimshospitals.com/) is a prominent multi-specialty hospital known for excellence in various medical fields, providing advanced medical treatments with a skilled team.",
        "4. [Nizam's Institute of Medical Sciences (NIMS), Hyderabad](http://www.nims.edu.in/)",
        "5. CARE Hospitals" "[CARE Hospitals](https://www.carehospitals.com/) is a well-established healthcare institution recognized for quality care in cardiology, neurology, nephrology, and oncology.",
        "6. Continental Hospitals" "[Continental Hospitals](https://continentalhospitals.com/) is located in Hyderabad’s financial district and is known for high-quality healthcare, emergency care, and advanced specialties.",
        "7. AIG Hospitals" "[AIG Hospitals](https://aighospitals.com/) specializes in gastroenterology and other medical fields, with state-of-the-art facilities and an expert team of doctors.",
        "8. Sunshine Hospitals" "[Sunshine Hospitals](https://www.sunshinehospitals.com/) is a multi-super specialty institution, known for expertise in orthopedics, cardiology, and various other medical specialties.",
    ]
    st.write("\n".join(hospitals_hyderabad))
    #insert image
...
# FAQ & Feedback Page
if selected == 'FAQ & Feedback':
    st.title("FAQ & Feedback")
    
    # Frequently Asked Questions
    st.markdown("## Frequently Asked Questions")
    faqs = {
        "What is the Health Guard Prediction System?": "It is a machine-learning-based healthcare system designed to predict diseases based on user inputs. It provides insights using advanced algorithms and historical data analysis.",
        "How accurate are the predictions?": "The system leverages advanced ML algorithms to provide high accuracy, but it is not a substitute for medical advice. The accuracy varies based on the quality of input data.",
        "Can I use this for self-diagnosis?": "The system should be used for preliminary analysis. Always consult a doctor for professional diagnosis and treatment.",
        "What diseases can it predict?": "The system currently predicts Diabetes, Heart Disease, Breast Cancer, Liver Disease, and Parkinson’s Disease using trained machine learning models.",
        "Is my data secure?": "Yes, we prioritize user privacy and ensure that all data is processed securely and is not stored permanently. No personal information is shared with third parties.",
        "Do I need any medical knowledge to use this system?": "No, the system is designed for ease of use. It guides users through the input process to generate predictions with simple user-friendly interfaces.",
        "How frequently should I use the system?": "It is advisable to use it when you experience symptoms or as a preventive checkup periodically. Regular usage can help track changes in health conditions.",
        "Can doctors use this system?": "Yes, medical professionals can use this system as an assistive tool for quick preliminary assessments. It helps them get an early analysis based on input data.",
        "What technology does the system use?": "The system employs machine learning models such as logistic regression, decision trees, and neural networks, trained on medical datasets for disease prediction.",
        "Can this system replace a doctor?": "No, it is only an assistive tool. It can provide preliminary insights but should never replace a consultation with a certified healthcare professional."
    }
